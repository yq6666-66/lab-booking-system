...
SCHEMAS = [
    ...
    ("GET",  "/api/me/notifications/export", {"filename": T_STR, "content": T_STR}),
    ("GET",  "/api/admin/slots/conflicts?date={today}", {"conflicts": T_ANY, "total": T_INT}),
    ("GET",  "/api/admin/credit-summary", {"distribution": T_ANY, "total_users": T_INT, "restricted_users": T_ANY, "recent_ledger": T_ANY}),
