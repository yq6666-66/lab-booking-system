...
| 2 | **集成测试** | tests/integration.py | T01–T36 共 38 项断言组 | ✅ 全过 | docs/evidence/results-full-merge/ |
...
| 8 | **黑盒测试** | integration.py 经 HTTP（不知内部实现） | 全部 38 项集成断言组 | ✅ 全过 | results-full-merge/ |
