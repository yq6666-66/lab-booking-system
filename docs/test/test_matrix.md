...
| 2 | **集成测试** | tests/integration.py | T01–T42 共 44 项断言组（含 T41 资源管理、T42 利用率对账） | ✅ 全过 | docs/evidence/results-full-merge/ |
...
| 8 | **黑盒测试** | integration.py 经 HTTP（不知内部实现） | 全部 44 项集成断言组 | ✅ 全过 | results-full-merge/ |
