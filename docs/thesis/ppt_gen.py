...
slide("九、验证体系：五层自动化", bullets=[
    ...
    ("集成实验 70 项断言组（T01–T69 及 CLI 检查；组合验证 T63–T67、凭据生命周期 T68、约束感知建议 T69）", 0),
...
slide("十三、总结与展望", bullets=[
    ...
    ("一体化深化：资源声明配额、实机时利用率、周期发布、每周配额、日历导出、Prometheus 端点、审批流、候补策略、资格授权、信用账户、约束感知建议", 0),
