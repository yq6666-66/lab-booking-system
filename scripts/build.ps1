...
try {
 ...
 $own=@('src/main.c','src/util.c','src/db.c','src/service.c','src/booking.c','src/asset.c','src/stats.c','src/token.c','src/http.c','src/ratelimit.c','src/metrics.c','src/log.c')
 ...
 & gcc @flags @checks -Ivendor/unity/src -DWATCHDOG_MS=50 vendor/unity/src/unity.c src/util.c src/db.c src/service.c src/booking.c src/asset.c src/stats.c src/token.c src/ratelimit.c src/log.c tests/unit.c @objects @libs -o ("build/unit-tests"+$suffix+".exe")
